...
function confirmarAsistencia() {
    ...
    const mensaje = `Hola, soy ${invitado} y confirmo mi asistencia con ${pases} pases para la fiesta de quince años de Ana Lucía.`;
...
function elegirAplicacion() {
    // Enlaces específicos para Google Maps y Waze con la ubicación correcta
    const enlaceGoogleMaps = 'https://maps.app.goo.gl/dfD9cMEbSAdn56qV8';
    const enlaceWaze = 'https://waze.com/ul?ll=14.558065,-90.729567&navigate=yes'; // Coordenadas basadas en la ubicación proporcionada

    // Muestra una alerta para que el usuario elija
    const usarGoogleMaps = confirm("¿Deseas abrir la ubicación en Google Maps? (Selecciona Cancelar para abrir en Waze)");

    // Redireccionar según la opción elegida
    if (usarGoogleMaps) {
...
function elegirAplicacionOtraDireccion() {
    ...
    const enlaceWaze = 'https://waze.com/ul?ll=14.558065,-90.729567&navigate=yes'; // Coordenadas específicas de la ubicación proporcionada
